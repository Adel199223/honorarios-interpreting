...
- In the browser app, open References -> Local Diagnostics and confirm the default live smoke and source-upload smoke commands are visible and copyable. This panel must remain read-only and Gmail-free.
