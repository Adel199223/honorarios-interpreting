...
2. Build from the isolated LegalPDF adapter contract smoke toward a future caller shim, keeping the source-upload, numbered-answer, prepared-review token, and stale-token rejection path executable without writing to LegalPDF Translate yet.
