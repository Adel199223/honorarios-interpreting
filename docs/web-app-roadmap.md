...
- Local Diagnostics panel in the browser app, listing the safe live smoke, source-upload smoke, supporting-attachment smoke, isolated source-upload smoke, isolated supporting-attachment smoke, Browser/IAB review smoke, and Browser/IAB upload smoke commands without running shell commands or touching Gmail.
