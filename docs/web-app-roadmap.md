...
2. Add a richer reviewed-import history screen if LegalPDF reference imports become frequent enough to need filtering, rollback, or comparison beyond the generated private apply reports.
