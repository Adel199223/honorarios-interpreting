...
- Local Diagnostics panel in the browser app, listing the safe live smoke, source-upload smoke, isolated source-upload smoke, and Browser/IAB review smoke commands without running shell commands or touching Gmail.
